...
// Transform seed data for courses category
const transformedProducts: (Product & { plans: Plan[] })[] = seedProducts
  ...
  .map((p, index) => ({
    ...
    plans: p.plans.map((plan, planIndex) => ({
      ...
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
      // Ensure courses are marked as free
      is_free: plan.price_usd === 0 || plan.price_pkr === 0,
    })),
  }));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            <div className="flex justify-center mb-6">
              <div className="relative w-20 h-20 rounded-3xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
              Unlock your potential with our collection of free courses across various subjects. 
              From digital marketing to programming - all free for our valued customers.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              ...
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.05] border border-white/[0.08]">
                ...
                <span className="text-sm text-white/70">Free Access</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white placeholder:text-white/40 focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 transition-all"
              />
            </div>
          </motion.div>
          ...
          <div className="flex items-center justify-center mb-6">
            <p className="text-sm text-white/50">
              {filteredProducts.length} free courses available
            </p>
          </div>
